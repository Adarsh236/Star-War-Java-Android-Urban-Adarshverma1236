...
public class FavoriteDbHelper extends SQLiteOpenHelper {
    ...
    /*private static final String DATABASE_NAME = "favoritecharacter1.db";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        final String SQL_CREATE_FAVORITE_TABLE = "CREATE TABLE " + FavoriteContract.FavoriteEntry.TABLE_NAME + " (" +
                FavoriteContract.FavoriteEntry._ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
                FavoriteContract.FavoriteEntry.COLUMN_CHARACTERID + " TEXT, " +
                FavoriteContract.FavoriteEntry.COLUMN_NAME + " TEXT NOT NULL, " +
                FavoriteContract.FavoriteEntry.COLUMN_CREATED + " TEXT NOT NULL, " +
                FavoriteContract.FavoriteEntry.COLUMN_EDITED + " TEXT NOT NULL, " +
